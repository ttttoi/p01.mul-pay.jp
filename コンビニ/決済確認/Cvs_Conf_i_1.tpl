...
gtag('config', 'UA-110965514-1');
	...
	<title>コンビニ決済確認　Kanatta決済サービス</title>
		...
		<form action="{$ExecURL|htmlspecialchars}" onsubmit="return blockForm()" method="post">
			...
			<div class="block">
				<div class="bl_title">
					<div class="bl_title_inner">
						<h2>
							<span class="p">この内容で決済を始めます。</span>
						</h2>
					</div>
				</div>
				...
				<div class="bl_body">
					...
					<table class="generic" summary="credit_1" id="credit">
						<tr>
							<th>ご利用するコンビニ</th>
							<td>{$CvsName|htmlspecialchars}</td>
						</tr>
						<tr>
							<th>氏名</th>
							<td>
						...
						<tr>
							<th>フリガナ</th>
							<td>
								{$CustomerKana|htmlspecialchars}
							</td>
						</tr>
						<tr>
							<th>電話番号</th>
							<td>
								{$TelNo|htmlspecialchars}
							</td>
						</tr>
						<tr>
							<th>ご連絡先メールアドレス</th>
							<td>
								{$MailAddress|htmlspecialchars}
							</td>
						</tr>
					</table>
					...
					<p class="control">
						...
						<p class="back-btn"><a href="{$EntryURL|htmlspecialchars}">戻る</a></p>
					</div></div>
			</div>
