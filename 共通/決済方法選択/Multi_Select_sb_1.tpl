...
プロジェクトの実行やリターンの発送（履行）などは、全て起案者の責任のもと行われます。</dd>
    ...
    <dl>
        ...
        <dt>コンビニ払い</dt>
        <dd>全国の主要なコンビニエンスストア（セブンイレブンを除く）でご利用いただけます。<br>支払い期限は、決済した時刻から翌営業日の同時刻までとなります。</dd>
        <dt>銀行振込</dt>
        <dd>全国の金融機関ATMまたはネットバンキングにてご利用いただけます。<br>支払い期限は、決済した時刻から翌営業日の同時刻までとなります。</dd>
    </dl>
</div>
